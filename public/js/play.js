...
var insertContent = (type, payload, puzzles, index, prevIndex) => {
  ...
  switch(type){
    ...
    case "ranking":
      ...
      break;
    case "text":
      const replacedText = (payload.text || "").toString().replaceAll("__ESCAPP_USER__",encodeURIComponent(username)).replaceAll("__ESCAPP_TOKEN__",token).replaceAll("__ESCAPP_LOCALE__",i18n.locale)
